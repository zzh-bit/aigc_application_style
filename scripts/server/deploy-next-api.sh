...
PS2_DEBATE_MAX_TOKENS="${PS2_DEBATE_MAX_TOKENS:-250}"
PS2_DEBATE_HOST_MAX_TOKENS="${PS2_DEBATE_HOST_MAX_TOKENS:-280}"
...
VIVO_APP_ID=${VIVO_APP_ID}
PS2_DEBATE_MAX_TOKENS=${PS2_DEBATE_MAX_TOKENS}
PS2_DEBATE_HOST_MAX_TOKENS=${PS2_DEBATE_HOST_MAX_TOKENS}
PORT=${APP_PORT}
NODE_ENV=production
EOF
